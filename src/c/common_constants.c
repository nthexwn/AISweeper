...
const char* response_code_strings[RESPONSE_CODE_COUNT] =
{
  ...
  "REVEAL_POSITION_Y_COORDINATE_TOO_LOW", // 25
  "REVEAL_POSITION_Y_COORDINATE_TOO_HIGH", // 26
  "REVEAL_POSITION_MUST_BE_UNREVEALED", // 27
  "REVEAL_POSITION_MUST_UNFLAG_FIRST", // 28
